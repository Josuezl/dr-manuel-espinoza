                ...
                return (
                  ...
                  >
                    {procedure.href ? (
                      <Link
                        href={procedure.href}
                        aria-label={`Ver más sobre ${procedure.name}`}
                        className="block h-full rounded-[1.75rem] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cobalt focus-visible:ring-offset-2"
                      >
                        {card}
                      </Link>
                    ) : (
